                                ...
                                <div id="horizontal-form">
                                    ...
                                    <form class="form-horizontal" role="form" action="" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            <label for="li_title" class="col-sm-2 control-label no-padding-right">链接标题</label>
                                            <div class="col-sm-6">
                                                <input class="form-control" id="li_title" placeholder="" name="li_title" required="" type="text" value="<?php echo ($linkesa["li_title"]); ?>">
                                            </div>
                                            <p class="help-block col-sm-4 red">* 必填</p>
                                        </div>

                                        <div class="form-group">
                                            <label for="li_url" class="col-sm-2 control-label no-padding-right">文章作者</label>
                                            <div class="col-sm-6 ">
                                                <input class="form-control" id="li_url" placeholder="" name="li_url"  type="text" value="<?php echo ($linkesa["li_url"]); ?>">
                                            </div>
                                        </div>

                                        <div class="form-group">
                                            <label for="li_pic" class="col-sm-2 control-label no-padding-right">文章图片</label>
                                            <div class="col-sm-6">
                                                <p  class="help-block col-sm-2 ">
                                                    <?php if($linkesa['li_pic'] != '' ): ?><img src="/chuangyi/<?php echo ($linkesa["li_pic"]); ?>"  alt="">
                                                    <?php else: ?>暂无图片<?php endif; ?>
                                                </p>
                                                <label for="li_pic" class="col-sm-2 control-label "></label>
                                                <input type="file" id="li_pic" name="li_pic" >
                                        ...
                                        <div class="form-group">
                                            <label for="li_des" class="col-sm-2 control-label no-padding-right">链接详细</label>
                                            <div class="col-sm-6">
                                                <textarea name="li_des" id="li_des" cols="60" rows="5"><?php echo ($linkesa["li_des"]); ?></textarea>
                                            </div>
                                        </div>

                                        <input type="hidden" name="li_id" value="<?php echo ($linkesa["li_id"]); ?>">
