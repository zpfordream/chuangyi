                                ...
                                <div id="horizontal-form">
                                    ...
                                    <form class="form-horizontal" role="form" action="" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            <label for="cf_name" class="col-sm-2 control-label no-padding-right">链接标题</label>
                                            <div class="col-sm-6">
                                                <input class="form-control" id="cf_name" placeholder="" name="cf_name" required="" type="text" value="<?php echo ($confesa["cf_name"]); ?>">
                                            </div>
                                            <p class="help-block col-sm-4 red">* 必填</p>
                                        </div>

                                        <div class="form-group">
                                            <label for="cf_ename" class="col-sm-2 control-label no-padding-right">文章作者</label>
                                            <div class="col-sm-6 ">
                                                <input class="form-control" id="cf_ename" placeholder="" name="cf_ename"  type="text" value="<?php echo ($confesa["cf_ename"]); ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <label class="radio-inline">
                                                    <input type="radio" name="cf_type" id="inlineRadio1" value="text" <?php if($confesa['cf_type'] == 'text' ): ?>checked<?php endif; ?>  > 单行文本
                                                </label>
                                                <label class="radio-inline">
                                                    <input type="radio" name="cf_type" id="inlineRadio2" value="radio"  <?php if($confesa['cf_type'] == 'radio' ): ?>checked<?php endif; ?> > 单选按钮
                                                </label>
                                                <label class="radio-inline">
                                                    <input type="radio" name="cf_type" id="inlineRadio3" value="textarea"  <?php if($confesa['cf_type'] == 'textarea' ): ?>checked<?php endif; ?> > 多行文本
                                                </label>
                                            </div>
                                        </div>

                                        <div class="form-group">
                                            <label for="cf_ename" class="col-sm-2 control-label no-padding-right">可选值</label>
                                            <div class="col-sm-6 ">
                                                <textarea name="cf_values" id="cf_values" cols="60" rows="5" ><?php echo ($confesa["cf_values"]); ?></textarea>
                                            </div>
                                        </div>


                                        <div class="form-group">
                                            <label for="cf_ename" class="col-sm-2 control-label no-padding-right">默认值</label>
                                            <div class="col-sm-6 ">
                                                <textarea name="cf_value" id="cf_value" cols="60" rows="5" ><?php echo ($confesa["cf_value"]); ?></textarea>
                                            </div>
                                        </div>


                                   <input type="hidden"  name="cf_id" value="<?php echo ($confesa["cf_id"]); ?>">
