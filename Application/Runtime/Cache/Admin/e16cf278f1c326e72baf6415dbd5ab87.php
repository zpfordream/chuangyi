                                ...
                                <div id="horizontal-form">
                                    ...
                                    <form class="form-horizontal" role="form" action="" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            <label for="ar_title" class="col-sm-2 control-label no-padding-right">标题名称</label>
                                            <div class="col-sm-6">
                                                <input class="form-control" id="ar_title" placeholder="" name="ar_title" required="" type="text">
                                            </div>
                                            <p class="help-block col-sm-4 red">* 必填</p>
                                        </div>

                                        <div class="form-group">
                                            <label for="ar_author" class="col-sm-2 control-label no-padding-right">作者</label>
                                            <div class="col-sm-6">
                                                <input class="form-control" id="ar_author" placeholder="" name="ar_author"  type="text">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <label class="radio-inline">
                                                    <input type="radio" name="ar_rem" id="inlineRadio1" value="0"> 不推荐
                                                </label>
                                                <label class="radio-inline">
                                                    <input type="radio" name="ar_rem" id="inlineRadio2" value="1"> 推荐
                                                </label>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <label for="ar_cateid" class="col-sm-2 control-label no-padding-right">所属栏目</label>
                                            <div class="col-sm-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <textarea name="ar_content" id="content" cols="60" rows="5"></textarea>
                                            </div>
                                        </div>
