                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <select class="form-control" name="parentid" id="parentid">
                                                    ...
                                                    <?php if(is_array($categoryes)): $i = 0; $__LIST__ = $categoryes;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["cate_id"]); ?>" <?php if($categoryesa['parentid'] == $vo['cate_id'] ): ?>selected='selected'<?php endif; ?> <?php if($categoryesa['cate_id'] == $vo['cate_id'] ): ?>display = 'none'<?php endif; ?>   >
