                                ...
                                <div id="horizontal-form">
                                    ...
                                    <form class="form-horizontal" role="form" action="" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            <label for="ar_title" class="col-sm-2 control-label no-padding-right">分类名称</label>
                                            <div class="col-sm-6">
                                                <input class="form-control" id="ar_title" placeholder="" name="ar_title" required="" type="text" value="<?php echo ($articlesa["ar_title"]); ?>">
                                            </div>
                                            <p class="help-block col-sm-4 red">* 必填</p>
                                        </div>

                                        <div class="form-group">
                                            <label for="ar_author" class="col-sm-2 control-label no-padding-right">文章作者</label>
                                            <div class="col-sm-6 ">
                                                <input class="form-control" id="ar_author" placeholder="" name="ar_author"  type="text" value="<?php echo ($articlesa["ar_author"]); ?>">
                                            </div>
                                        </div>

                                        <div class="form-group">
                                            <label for="ar_pic" class="col-sm-2 control-label no-padding-right">文章图片</label>
                                            <div class="col-sm-6">
                                                <p  class="help-block col-sm-2 ">
                                                    <?php if($articlesa['ar_pic'] != '' ): ?><img src="/chuangyi/<?php echo ($articlesa["ar_pic"]); ?>"  alt="">
                                                    <?php else: ?>暂无图片<?php endif; ?>
                                                </p>
                                                <label for="ar_pic" class="col-sm-2 control-label "></label>
                                                <input type="file" id="ar_pic" name="ar_pic" >
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <label class="radio-inline">
                                                    <input type="radio" name="ar_rem" id="inlineRadio1" value="1" <?php if($articlesa['ar_rem'] == 1 ): ?>checked<?php endif; ?> >推荐
                                                </label>
                                                <label class="radio-inline">
                                                    <input type="radio" name="ar_rem" id="inlineRadio2" value="0" <?php if($articlesa['ar_rem'] == 0 ): ?>checked<?php endif; ?>> 不推荐
                                                </label>
                                        ...
                                        <div class="form-group">
                                            <label for="ar_cateid" class="col-sm-2 control-label no-padding-right">上级栏目</label>
                                            <div class="col-sm-6">
                                                <select class="form-control" name="ar_cateid" id="ar_cateid">
                                                    <?php if(is_array($categoryes)): $i = 0; $__LIST__ = $categoryes;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["cate_id"]); ?>" <?php if($articlesa['ar_cateid'] == $vo['cate_id'] ): ?>selected='selected'<?php endif; ?> >
                                        ...
                                        <input type="hidden" name="ar_id" value="<?php echo ($articlesa["ar_id"]); ?>">
